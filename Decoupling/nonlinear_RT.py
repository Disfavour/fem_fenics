...
def nonlinear_RT(degree=2, mesh_size=100, tau=0.005, T=5, t_fig4=(1, 2, 3, 4, 5)):
    ...
    np.save(f"data/nonlinear_RT_d{degree}_ms{mesh_size}_tau{tau}.npy", np.array((ts, Es, xs, *rs)).T)
