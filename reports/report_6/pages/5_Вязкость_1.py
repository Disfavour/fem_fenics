...
Домножаем на $\left( 1 + \kappa \tau A \right)^{-1}$
$$
\frac {u^{n+1} - u^n} \tau
+ \left( 1 + \kappa \tau A \right)^{-1} A \frac {u^{n+1} + u^n} 2 = 0
$$

C учетом 
$$
\begin{CD}
    \frac 1 {1+x} @>x \to 0 >> 1 - x
\end{CD}
$$
$$
A = -A^*
...
Получаем
$$
\left( 1 + \kappa \tau A \right)^{-1} A \approx \left( 1 - \kappa \tau A \right) A
= A - \kappa \tau A^2
= A + \kappa \tau A^* A
$$

Добавление слагаемого соответствует регуляризации (монотонизации)
