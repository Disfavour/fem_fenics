...
if __name__ == '__main__':
    ...
    x1, u1, t, m = calculate(mesh_size=200, tau=0.0025, degree=2, T=0.6, ts2store=[0.0, 0.2, 0.4, 0.6], kappa=0.08, ntest=1, info=True)

    x2, u2, t, m = calculate(mesh_size=200, tau=0.0025, degree=2, T=0.6, ts2store=[0.0, 0.2, 0.4, 0.6], kappa=0.16, ntest=1, info=True)
