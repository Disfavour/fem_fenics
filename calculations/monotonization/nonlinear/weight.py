...
if __name__ == '__main__':
    ...
    x, u, x_e, ue, t, err = calculate(mesh_size=200, tau=0.0025, degree=1, T=0.6, ts2store=[0.2, 0.4, 0.6], kappa=0.16, ntest=2, info=True)
    x, u2, x_e, ue, t, err2 = calculate(mesh_size=200, tau=0.0025, degree=1, T=0.6, ts2store=[0.2, 0.4, 0.6], kappa=1.28, ntest=2, info=True)
    x, u3, x_e, ue, t, err3 = calculate(mesh_size=200, tau=0.0025, degree=1, T=0.6, ts2store=[0.2, 0.4, 0.6], kappa=2.56, ntest=2, info=True)
